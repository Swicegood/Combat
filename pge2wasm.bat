...
echo %CPP%
	if exist "./assets" (
		...
		call em++ -std=c++17 -O1 -s ALLOW_MEMORY_GROWTH=1 -s MAX_WEBGL_VERSION=2 -s MIN_WEBGL_VERSION=2 -s USE_LIBPNG=1 "%CPP%" -o .\WASM\pge.html -I %OLCPGE% --preload-file ./assets
	) else (
